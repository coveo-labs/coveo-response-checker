...
.notmandatory { opacity:0.6}  
.crs th {color: #1e2541;font-weight: bold;} 
.crs {border:none;margin-top: 5px;width: auto;float:left;padding:10px;border-spacing: 0px;} 
.crs  th {	text-align: left;	border:1px solid #C0C0C0;		padding:5px;font-family:Arial !important;	font-size:11pt !important;	background:#F0F0F0;	}	
